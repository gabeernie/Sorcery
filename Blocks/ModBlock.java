...
public class ModBlock extends Block {
    public ModBlock(Material material, Float hardness, Float resistance, SoundType sound, String registryName) {
        ...
        public static final ChondriteBlastFurnace chondrite_furnace = new ChondriteBlastFurnace();

        @ObjectHolder("sorcery:chondriteblastfurnace")
        public static final TileEntityType<ChondriteBlastFurnaceEntity> chondrite_furnace_entity = new TileEntityType<ChondriteBlastFurnaceEntity>;
